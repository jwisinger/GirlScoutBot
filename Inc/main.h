...
#define RIGHT_RTN_Pin GPIO_PIN_0
...
#define LEFT_RTN_Pin GPIO_PIN_5
#define LEFT_RTN_GPIO_Port GPIOA
#define DOWN_RTN_Pin GPIO_PIN_6
#define DOWN_RTN_GPIO_Port GPIOA
#define DOWN_Pin GPIO_PIN_0
#define DOWN_GPIO_Port GPIOB
#define DOWN_EXTI_IRQn EXTI0_IRQn
#define UP_RET_Pin GPIO_PIN_1
#define UP_RET_GPIO_Port GPIOB
